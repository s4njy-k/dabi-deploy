"""Cross-dataset OS _update_by_query consistency pass — applies derived columns to dabi-domains from completed daily ingests.
...
DESCRIPTION = "Cross-dataset OS _update_by_query consistency pass — applies derived columns to dabi-domains from completed daily ingests."
