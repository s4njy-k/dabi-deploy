"""OpenINTEL CT-log forward DNS — raw FQDN observations into CH dabi.ct_fqdn_observations; apex aggregates pushed to OS.
...
PIPELINE = "openintel-ctlog"
DESCRIPTION = "OpenINTEL CT-log forward DNS — raw FQDN observations into CH dabi.ct_fqdn_observations; apex aggregates pushed to OS."
