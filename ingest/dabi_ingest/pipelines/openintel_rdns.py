"""OpenINTEL bulk IPv4 reverse DNS — billions of (ip4, ptr) tuples bulk-loaded into CH dabi.rdns (the killer CH workload).
...
PIPELINE = "openintel-rdns"
DESCRIPTION = "OpenINTEL bulk IPv4 reverse DNS — billions of (ip4, ptr) tuples bulk-loaded into CH dabi.rdns (the killer CH workload)."
