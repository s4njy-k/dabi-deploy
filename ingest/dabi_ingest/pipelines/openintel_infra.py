"""OpenINTEL infrastructure measurement — NS/MX resolved daily; populates dabi-infrastructure (OS) and bidirectional refs on dabi-domains.
...
PIPELINE = "openintel-infra"
DESCRIPTION = "OpenINTEL infrastructure measurement — NS/MX resolved daily; populates dabi-infrastructure (OS) and bidirectional refs on dabi-domains."
