"""GCS Nearline archive sync — moves yesterday's /parquet/* to gs://dabi-prod-archive/ and purges /mnt/scratch.
...
PIPELINE = "archive"
DESCRIPTION = "GCS Nearline archive sync — moves yesterday's /parquet/* to gs://dabi-prod-archive/ and purges /mnt/scratch."
