"""ICANN CZDS — fetch approved gTLD zone files, preprocess to apex Parquet, bulk-index into OS dabi-domains.
...
PIPELINE = "czds"
DESCRIPTION = "ICANN CZDS — fetch approved gTLD zone files, preprocess to apex Parquet, bulk-index into OS dabi-domains."
