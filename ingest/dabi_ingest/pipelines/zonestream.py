"""OpenINTEL Zonestream — long-running WebSocket consumer for 3 topics (newly_registered_domain/fqdn, zone_diff). Daemon, not scheduled.
...
PIPELINE = "zonestream"
DESCRIPTION = "OpenINTEL Zonestream — long-running WebSocket consumer for 3 topics (newly_registered_domain/fqdn, zone_diff). Daemon, not scheduled."
