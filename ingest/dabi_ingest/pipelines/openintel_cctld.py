"""OpenINTEL ccTLD apex lists — weekly (Mondays). Up to 307 ccTLDs from CT-derived apex inventories.
...
DESCRIPTION = "OpenINTEL ccTLD apex lists — weekly (Mondays). Up to 307 ccTLDs from CT-derived apex inventories."
